...
\begin{tikzpicture}
  ...
  \end{axis}
\end{tikzpicture}
\caption{Observed error of source-node aggregate-frequency queries on top-500 node aggregate-frequencies of the IP-Trace dataset} \label{fig:agg3}
\end{figure}
...
\begin{tikzpicture}
  ...
  \end{axis}
\end{tikzpicture}
\caption{Observed error of destination-node aggregate-frequency queries on top-500 node aggregate-frequencies of the IP-Trace dataset} \label{fig:agg4}
\end{figure}
